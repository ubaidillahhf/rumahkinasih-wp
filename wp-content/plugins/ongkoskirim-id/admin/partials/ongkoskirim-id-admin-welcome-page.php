...
<div class="white-section row">
    ...
    <div class="imac col-sm-5" style="margin-top: 105px; margin-bottom: 80px">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/2SM1ML1qjic" frameborder="0" allowfullscreen></iframe>
    </div>
    <!--imac-->
